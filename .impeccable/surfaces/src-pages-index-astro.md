...
- **A fourth project, the site itself, was added**, with its repository linked; a fifth (Wordle-Solver, a small shipped Python tool) and a sixth (ReflowTask, a self-hosted scheduler running on a Raspberry Pi) followed in September 2026.
